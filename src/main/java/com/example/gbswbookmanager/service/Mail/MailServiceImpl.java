...
public class MailServiceImpl implements MailService {
    ...
    public MimeMessage createMessage(String name, String email) throws Exception {
        ...
        MailToken mailToken = MailToken.createEmailToken(email, code);
    ...
    public Boolean checkCode(String email, String code) {
        ...
        MailToken mailToken = mailTokenRepository.findByEmailAndExpirationDateAfterAndExpired(email, time, false);

        if (mailToken.getCode().equals(code)) {
            mailToken.setTokenToUsed();
            mailTokenRepository.save(mailToken);
            return true;
        } else {
            return false;
